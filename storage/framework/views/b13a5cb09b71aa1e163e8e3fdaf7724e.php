...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('department_name')); ?>">
...
<div class="modal fade show" id="confirmModal" style="display: block;" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-lg">
        <form method="POST" action="<?php echo e(route('departments.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo e(route('departments.create')); ?>" class="btn btn-secondary">Cancel</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\university_student_management_website\resources\views/departments/create.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('student_name', $student->student_name)); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('phone', $student->phone)); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('date_of_birth', $student->date_of_birth)); ?>">
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <option value="<?php echo e($gender->value); ?>" <?php echo e(old('gender', $student->gender) == $gender->value ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('enrollment_date', $student->enrollment_date)); ?>">
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <option value="<?php echo e($semester->value); ?>" <?php echo e(old('current_semester', $student->current_semester) == $semester->value ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <option value="<?php echo e($department->id); ?>" <?php echo e(old('department_id', $student->department_id) == $department->department_id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <option value="<?php echo e($status->value); ?>" <?php echo e(old('status', $student->status) == $status->value ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-3">
            <label for="photo_url" class="form-label">Upload New Photo</label>
            <input type="file" name="photo_url" class="form-control <?php $__errorArgs = ['photo_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
        ...
        <form method="POST" action="<?php echo e(route('students.update',$student->id)); ?>" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo e(route('students.edit',$student->id)); ?>" class="btn btn-secondary">Cancel</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\university_student_management_website\resources\views/students/edit.blade.php ENDPATH**/ ?>
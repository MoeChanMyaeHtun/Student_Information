...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <option value="<?php echo e($department->id); ?>"
                        <?php echo e(old('id', $course->department_id ?? '') == $department->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                    <option value="" disabled <?php echo e(old('semester', $course->semester ?? '') ? '' : 'selected'); ?>>Select Semester</option>
                    ...
                    <option value="<?php echo e($semester->value); ?>"
                        <?php echo e(old('semester', $course->semester ?? '') == $semester->value ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <option value="<?php echo e($teacher->teacher_id); ?>"
                        <?php echo e(old('teacher_id', $course->teacher_id ?? '') == $teacher->teacher_id ? 'selected' : ''); ?>>
        ...
        <form method="POST" action="<?php echo e(route('courses.update',$course->id)); ?>" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Confirm Course Edition</h5>
                </div>
                <div class="modal-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><strong>Teacher:</strong> <?php echo e($teacher->find(old('teacher_id'))->teacher_name); ?></li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <a href="<?php echo e(route('courses.edit',$course->id)); ?>" class="btn btn-secondary">Cancel</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\university_student_management_website\resources\views/courses/edit.blade.php ENDPATH**/ ?>
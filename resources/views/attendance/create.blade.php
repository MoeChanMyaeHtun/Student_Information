        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <select name="status" class="form-control @error('status') is-invalid @enderror">
                    ...
                    @foreach(\App\Enums\AttendanceStatus::values() as $status)
            ...
            <div class="col-md-6">
                ...
                <input type="date" name="attendance_date" class="form-control @error('attendance_date') is-invalid @enderror" value="{{ old('attendance_date') }}">
        ...
        <form method="POST" action="{{ route('attendance.store') }}" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{{ route('attendance.create') }}" class="btn btn-secondary">Cancel</a>

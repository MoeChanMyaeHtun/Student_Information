            ...
            <div class="col-md-6">
                ...
                <select name="semester" class="form-select @error('semester') is-invalid @enderror">
                    ...
                    <option value="{{ $semester->value }}"
                        {{ old('semester', $course->semester ?? '') == $semester->value ? 'selected' : '' }}>
                        {{ $semester->value }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="col-md-6">
                ...
                <select name="teacher_id" class="form-control @error('teacher_id') is-invalid @enderror">
                    ...
                    <option value="{{ $teacher->teacher_id }}"
                        {{ old('teacher_id', $course->teacher_id ?? '') == $teacher->teacher_id ? 'selected' : '' }}>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><strong>Teacher:</strong> {{ $teacher->find(old('teacher_id'))->teacher_name }}</li>
                    </ul>
                </div>
                <div class="modal-footer">
                    <a href="{{ route('courses.edit',$course->id) }}" class="btn btn-secondary">Cancel</a>

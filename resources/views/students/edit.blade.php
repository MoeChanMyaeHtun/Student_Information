    ...
    <form action="{{ route('students.create.validate') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            <div class="col">
                ...
                <input type="text" name="student_name" class="form-control @error('student_name') is-invalid @enderror" value="{{ old('student_name', $student->student_name) }}">
                @error('student_name')
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="date" name="enrollment_date" class="form-control @error('enrollment_date') is-invalid @enderror" value="{{ old('enrollment_date', $student->enrollment_date) }}">
            ...
            <div class="col-md-6">
                ...
                <select name="current_semester" class="form-select @error('current_semester') is-invalid @enderror">
                    ...
                    <option value="{{ $semester->value }}" {{ old('current_semester', $student->current_semester) == $semester->value ? 'selected' : '' }}>
                        {{ $semester->value }}
                    </option>
                    @endforeach
                </select>
        ...
        <form method="POST" action="{{ route('students.update',$student->id) }}" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{{ route('students.edit',$student->id) }}" class="btn btn-secondary">Cancel</a>

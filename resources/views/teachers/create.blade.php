    ...
    <form action="{{ route('teachers.create.validate') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" name="teacher_name" class="form-control @error('teacher_name') is-invalid @enderror" value="{{ old('teacher_name') }}">
                @error('teacher_name')
        ...
        <form method="POST" action="{{ route('teachers.store') }}" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{{ route('teachers.create') }}" class="btn btn-secondary">Cancel</a>
